...
import type { Bgt, BgtInterface } from "../Bgt";
...
export class Bgt__factory {
  static readonly abi = _abi;
  static createInterface(): BgtInterface {
    return new Interface(_abi) as BgtInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Bgt {
    return new Contract(address, _abi, runner) as unknown as Bgt;
  }
}
